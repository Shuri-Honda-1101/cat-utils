...
import (
	...
	"github.com/Shuri-Honda-1101/cat-utils/ent/schema"
...
func init() {
	...
	// cat.NameValidator is a validator for the "name" field. It is called by the builders before save.
	cat.NameValidator = func() func(string) error {
		validators := catDescName.Validators
