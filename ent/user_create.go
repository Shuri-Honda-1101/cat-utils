...
func (uc *UserCreate) AddCatIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddCatIDs(ids...)
	return uc
}

// AddCats adds the "cats" edges to the Cat entity.
func (uc *UserCreate) AddCats(c ...*Cat) *UserCreate {
	ids := make([]uuid.UUID, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return uc.AddCatIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.CatsIDs(); len(nodes) > 0 {
